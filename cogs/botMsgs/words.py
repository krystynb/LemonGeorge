...
seth = [
        "Fuck that guy.",
        "Two words: NO. FF.",
        "You mean that asshole that never texts back ? *rolls eyes* yeah. ok.",
        "LOL. Dude develops his pre-frontal cortex ONE time and thinks he's too good to respond",
        "blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah that is what I hear when he speak",
        "You brought this up AGAIN?? Now I have to wipe my memory. *initialize delete* B) *booting sounds*"
        ]
